...
describe('Evolution Flow Integration', () => {
  ...
  describe('starter cat initialization and evolution', () => {
    ...
    it('should evolve from baby to teen at 2000 XP', () => {
      ...
      let evolved = store.addEvolutionXp('mini-meowww', 800);
      expect(evolved).toBeNull(); // No evolution yet

      evolved = useCatEvolutionStore.getState().addEvolutionXp('mini-meowww', 800);
      expect(evolved).toBeNull(); // Still baby at 1600

      evolved = useCatEvolutionStore.getState().addEvolutionXp('mini-meowww', 400);
  ...
  describe('xpToNextStage utility', () => {
    ...
    it('should return master info for adult stage', () => {
      ...
      expect(result!.xpNeeded).toBe(15000);
    });
